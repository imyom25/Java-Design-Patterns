...
public class CompositeDemo {
    ...
    public static void main(String[] args) {
        ...
        Employee developer1 = new Developer("Josh", 1, 100L);
        Employee developer2 = new Developer("Sam", 2, 200L);
        Employee developer3 = new Developer("Martin", 3, 200L);
        Employee developer4 = new Developer("Ryan", 6, 200L);
        Employee developer5 = new Developer("Ricky", 7, 200L);

        Employee lead1 = new Lead("Mike", 4, 2000L);
        Employee lead2 = new Lead("Chris", 5, 2000L);

        Employee manager = new Manager("John", 8, 50000L);
